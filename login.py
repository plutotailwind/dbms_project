...
Label(login_frame, text="Username", bg="#B2E4B2", fg="black", font=('Arial', 16)).grid(row=1, column=0, padx=10, pady=(50, 5))  # Increased padding
login_username = Entry(login_frame, font=('Arial', 16), width=20)
login_username.grid(row=1, column=1, padx=10, pady=(50, 5))  # Increased padding

Label(login_frame, text="Password", bg="#B2E4B2", fg="black", font=('Arial', 16)).grid(row=2, column=0, padx=10, pady=(5, 5))  # Increased padding
login_password = Entry(login_frame, show="*", font=('Arial', 16), width=20)
login_password.grid(row=2, column=1, padx=10, pady=(5, 50))  # Increased padding
